...
uses
  ...
  Vcl.ExtCtrls, Vcl.ComCtrls, uBaseDeDatos, Data.Win.ADODB;

type
  TfrmClientesHistorial = class(TfrmBaseFormList)
...
var
  frmClientesHistorial: TfrmClientesHistorial;

implementation

{$R *.dfm}

procedure TfrmClientesHistorial.FormShow(Sender: TObject);
begin
  inherited;

qHistorial.Close;
qHistorial.Parameters.ParamValues['ClienteId']:= ClienteId;
qHistorial.Open;

frmClientesHistorial.Caption:= 'Historial de cambios cliente: '+UpperCase(ClienteNombre);
