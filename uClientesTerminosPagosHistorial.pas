unit uClientesTerminosPagosHistorial;
...
uses
  ...
  dxLayoutControlAdapters, dxLayoutContainer, cxGridCustomTableView,
  cxGridTableView, cxGridDBTableView, Data.Win.ADODB, cxGridLevel, cxClasses,
  cxGridCustomView, cxGrid, Vcl.StdCtrls, cxButtons, dxLayoutControl,
  Vcl.ExtCtrls, Vcl.ComCtrls;

type
  TfrmClientesTerminosPagosHistorial = class(TfrmBaseFormList)
  ...
  public
    ...
    TerminoPagoNombre:String;
    { Public declarations }
  end;

var
  frmClientesTerminosPagosHistorial: TfrmClientesTerminosPagosHistorial;

implementation

{$R *.dfm}

procedure TfrmClientesTerminosPagosHistorial.FormShow(Sender: TObject);
begin
  inherited;


qHistorial.Close;
qHistorial.Parameters.ParamValues['TerminoPagoId']:= TerminoPagoId;
qHistorial.Open;

frmClientesTerminosPagosHistorial.Caption:= 'Historial de cambios Termino de pago: '+UpperCase(TerminoPagoNombre);
